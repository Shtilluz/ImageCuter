...
class SpriteCutterApp:
    ...
    def show_instructions(self):
        instructions = (
            ...
            "ЛИЦЕНЗИЯ: Разрешено свободное использование при ОБЯЗАТЕЛЬНОМ указании автора (Shtillgor) и ссылки на сайт (https://midgro.uz/) в заметном месте."
        )
    ...
    def show_author(self):
        author_info = (
            ...
            "Вы можете свободно использовать это ПО, но обязаны указывать автора и ссылку на сайт https://midgro.uz/ в заметном месте вашего проекта."
        )
